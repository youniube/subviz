var SUBVIZ_SURGE_0_1_39 = true;
var SubViz = (function () {
  'use strict';
  var VERSION = '0.1.39';
  var MARKER = 'SUBVIZ_SURGE_0_1_39';
  ...
  function main() {
    ...
    if (path === '/favicon.ico') return redirect(FAVICON_URL);
    if (path === '/favicon.png') return redirect(ICON_192_URL);
    if (path === '/apple-touch-icon.png') return redirect(APPLE_TOUCH_ICON_URL);
    if (path === '/icon-192.png') return redirect(ICON_192_URL);
    if (path === '/icon-512.png') return redirect(ICON_512_URL);
    if (path === '/site.webmanifest') return redirect(WEBMANIFEST_URL);

...
var SubViz = (function () {
  ...
  function htmlPage() {
    return [
      ...
      '<section class="panel input-panel"><label>订阅 URL</label><div class="row"><input id="url" placeholder="https://example.com/sub"><button id="analyze">拉取分析</button><button id="sample" class="ghost">演示数据</button></div><details><summary>或粘贴订阅原文 / Clash YAML</summary><textarea id="raw" placeholder="粘贴 vmess/vless/trojan/ss/ssr 或 Clash YAML"></textarea><button id="analyzeText" class="secondary">分析粘贴内容</button></details><div id="status" class="status">准备就绪。访问域名：<code>http://subviz.store/</code></div></section>',

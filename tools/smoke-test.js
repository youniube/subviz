...
assert(health.version === '0.1.41', 'unexpected version: ' + health.version);
assert(health.marker === 'SUBVIZ_SURGE_0_1_41', 'unexpected marker: ' + health.marker);

const app = request('/app.js?v=0.1.41');
